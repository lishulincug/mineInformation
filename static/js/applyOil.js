$(document).ready(function(){
		...
		$('#search').click(function(){
			function userlog(a){
				...
				var b = {
					...
					limit: limit,
					offset : (parseInt(a.page) - 1) * limit
				}
			...
			$("#choose").click(function(){
				if ($('#searchApplyCompany input:checked').length == 1){
					...
					var f = function(b){
						...
						b.data[0].unit[3] = b.data[0].unit[5];//经济类型
						b.data[0].unit[4] = b.data[0].unit[8];//法定代表人
						b.data[0].unit[5] = b.data[0].unit[6];//职工人数
						b.data[0].unit[6] = b.data[0].unit[11];//安全负责人
																//8专职安全员人数
						b.data[0].unit[8] = b.data[0].unit[12];//办公电话
						b.data[0].unit[9] = b.data[0].unit[14];//工商注册号
	...
	$('.sameButton').click(function(){
		...
		var f = function(b){
			...
			b.data[0].unit[8] = b.data[0].unit[12];//办公电话
			b.data[0].unit[9] = b.data[0].unit[14];//工商注册号
			b.data[0].unit[10] = b.threeThoget;
